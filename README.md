...
Este proyecto es la iniciativa de migrar el proyecto de financiera/kronos a nuevas tecnologias a nivel de cliente, esta generado con [ngX-Rocket](https://github.com/ngx-rocket/generator-ngx-rocket/)
version 6.1.0
